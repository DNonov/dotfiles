...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  "NERDTree slashes in nice blue color
	call <SID>X("NERDTreeDirSlash",s:foreground, "", "")
  "NERDTree Flags are same color as dirs
	call <SID>X("NERDTreeFlags",s:foreground, "", "")
	call <SID>X("NERDTreeDir",s:foreground, "", "")
	call <SID>X("NERDTreeOpenable",s:foreground, "", "")
  ...
  call <SID>X("jsFunction", s:blue, "", "")
	...
	call <SID>X("jsTry", s:blue, "", "")
	call <SID>X("jsCatch", s:blue, "", "")
